 ...
 *
 * Built on 2022-04-21 at 06:51 UTC
 */
...
class _StringsEn {
	...
	// Translations
	late final _StringsSampleEn sample = _StringsSampleEn._(_root);
}

// Path: sample
class _StringsSampleEn {
	...
	/// コメントはコメントとして出力されます。
	String message({required Object count, required Object suffix}) => '[${_root.sample.title}] You have pushed the button this many times: $count $suffix';
}
...
class _StringsJa implements _StringsEn {
	...
	// Translations
	@override late final _StringsSampleJa sample = _StringsSampleJa._(_root);
}

// Path: sample
class _StringsSampleJa implements _StringsSampleEn {
	...
	/// コメントはコメントとして出力されます。
	@override String message({required Object count, required Object suffix}) => '[${_root.sample.title}] ボタンを押した回数: $count $suffix';
}
